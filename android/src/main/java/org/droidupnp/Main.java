...
public class Main extends AppCompatActivity {
    ...
    // Controller
    public static IUpnpServiceController upnpServiceController = RNUpnpModule.upnpServiceController;
    public static IFactory factory = RNUpnpModule.factory;
...
//			factory = new org.droidupnp.controller.cling.Factory();
            factory = RNUpnpModule.factory;

        // Upnp service
        if (upnpServiceController == null)
//			upnpServiceController = factory.createUpnpServiceController(this);
            upnpServiceController = RNUpnpModule.upnpServiceController;
